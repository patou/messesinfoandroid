...
public class Server {
	...
	list = (List<Map<String, String>>) client.call("massinfov30.searchLocation", query, start, limit);
	return list;
    }
     ...
     * @throws XMLRPCException
     */
    public List<Map<String, Object>> searchSchedule(String query, int start, int pageSize) throws XMLRPCException {

	List<Map<String, Object>> list = null;
	list = (List<Map<String, Object>>) client.call("massinfov30.searchSchedule", query, start, pageSize);
	return list;
    }
	...
	List<Map<String, String>> list = null;
	list = (List<Map<String, String>>) client.call("massinfov30.getNearLocation", top_lat, top_lon, bottom_lat, bottom_lon);
	return list;
    }
	...
	List<Map<String, Object>> list = null;
	list = (List<Map<String, Object>>) client.call("massinfov30.getLocationSchedule", id, start, limit);
	return list;
    }
	...
	item = (Map<String, String>) client.call("massinfov30.getLocationInfo", id);
	return item;
    }
